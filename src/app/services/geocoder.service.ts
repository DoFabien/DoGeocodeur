...
export class GeocoderService {
    ...
    geocoderBan(row) {
        ...
        const url = "https://api-adresse.data.gouv.fr/search/?q=" + adresse_encoded + "&limit=1";
    ...
    geocoderBing(row) {
        ...
        const url = `https://dev.virtualearth.net/REST/v1/Locations/FR/${row.cp}/${row.commune}/${row.num + ' ' + row.adresse}?maxResults=1&key=${key}`
